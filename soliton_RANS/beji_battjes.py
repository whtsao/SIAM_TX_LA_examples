...
opts=Context.Options([
    ...
    # tank
    ("tank_dim", (75., 1.), "Dimensions of the tank"),
    ("toe", 55., "Toe of slope"),
    ("x0", 35., "Starting place of soliatry wave"),
...
column_gauge_locations = (((10.0,          0.0, 0.0), (10.0, tank_dim[1], 0.0)),
                          ((20.0,          0.0, 0.0), (20.0, tank_dim[1], 0.0)),
                          ((30.0,          0.0, 0.0), (30.0, tank_dim[1], 0.0)),
                          ((40.0,          0.0, 0.0), (40.0, tank_dim[1], 0.0)),
                          ((55.0,          0.0, 0.0), (55.0, tank_dim[1], 0.0)),
                          ((71.25,  16.25/50.0, 0.0), (71.25, tank_dim[1], 0.0)),
                          ((72.75,  17.75/50.0, 0.0), (72.75, tank_dim[1], 0.0)),
                          ((74.99,  19.99/50.0, 0.0), (74.99, tank_dim[1], 0.0)))
