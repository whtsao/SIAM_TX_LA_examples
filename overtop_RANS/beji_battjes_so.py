...
tnList=[0.0,ct.dt_init]+[ct.dt_init+ i*ct.dt_out1 for i in range(1,ct.nDTout1+1)]+[ct.T1+ i*ct.dt_out_hs for i in range(1,ct.nDTout_hs+1)]+[ct.T2+ i*ct.dt_out2 for i in range(1,ct.nDTout2+1)]

#----------original even time interval---------------
#if ct.opts.nsave == 0:
#    if ct.dt_fixed > 0:
