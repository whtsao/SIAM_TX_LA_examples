...
segmentFlags = [boundaryTags['y-'],
                ...
                boundaryTags['y+'],
                boundaryTags['x-'],
                0] # append interface bw cannel and absorption zone
...
dragAlpha = 1.e+6
xmcenter = [0.5*(18.95+37.7), 0.5*0.75]  # Set the center for the x absorption zone
tank.setAbsorptionZones(flags=2, epsFact_porous=1.0, center=xmcenter, orientation=[-1.,0.,0.],
                        dragAlpha=dragAlpha)
...
# ----- GAUGES ----- #
column_gauge_locations = ((( 5.7,          0.0, 0.0), ( 5.7, tank_dim[1], 0.0)),
                          ((10.5,     4.5/20.0, 0.0), (10.5, tank_dim[1], 0.0)),
                          ((12.5,          0.3, 0.0), (12.5, tank_dim[1], 0.0)),
                          ((13.5,          0.3, 0.0), (13.5, tank_dim[1], 0.0)),
                          ((14.5, 0.3-0.5/10.0, 0.0), (14.5, tank_dim[1], 0.0)),
                          ((15.7, 0.3-1.7/10.0, 0.0), (15.7, tank_dim[1], 0.0)),
                          ((17.3,          0.0, 0.0), (17.3, tank_dim[1], 0.0)))
